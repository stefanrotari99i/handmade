const page = () => {
  return (
    <main className="max-w-screen-2xl mx-auto my-20">
      ...
      <p className="mt-4">
        Your privacy is important to us. It is Handgemacht Skulpturen&apos;s
        policy to respect your privacy regarding any information we may collect
        from you across our website,{" "}
        <a href="https://handgemacht-skulpturen.com">
          https://handgemacht-skulpturen.com
        </a>
      ...
      <h3 className="text-xl font-bold mt-4">Device data</h3>
      <p>
        ...
        unique device identifiers, device settings, and geo-location data. What
      ...
      <h3 className="text-xl font-bold mt-4">Personal information</h3>
      ...
      <h2 className="text-2xl font-bold mt-8">2. Legal bases for processing</h2>
      <p>
      ...
      <h2 className="text-2xl font-bold mt-8">7. Cookies</h2>
      <p>
      ...
      <h2 className="text-2xl font-bold mt-8">8. Business transfers</h2>
      <p>
      ...
      <h2 className="text-2xl font-bold mt-8">9. Limits of our policy</h2>
      <p>
      ...
      <h2 className="text-2xl font-bold mt-8">10. Changes to this policy</h2>
      <p>
